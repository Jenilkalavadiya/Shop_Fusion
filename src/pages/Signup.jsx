...
const Signup = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="font-[sans-serif] bg-white max-w-7xl flex items-center justify-center p-4 mt-44">
        <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
          ...
          >
            ...
            <div className="mt-8">
              <button className="w-full py-2.5 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none">
                Create an account
              </button>
            </div>
