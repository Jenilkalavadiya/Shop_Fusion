...
const Loginpage = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (
      logggedUser.email === input.email &&
      logggedUser.password === input.password
    ) {
  ...
  return (
    <div className="font-[sans-serif]">
      <div className="min-h-[750px] flex fle-col items-center justify-center py-6 px-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="text-sm">
                  <p className="text-blue-600 hover:text-blue-500 font-semibold">
